...
a-html5"
        ...
        <div className="skill">
          <i className="fab fa-js"></i> JQuery
        </div>
        <div className="skill">
        ...
        <div className="skill">
          <i className="fas fa-paint-brush" aria-hidden="true"></i> Material-UI
        </div>
        <div className="skill">
      ...
      <div className="field">
        ...
        <div className="skill">
          <i className="fab fa-code"></i> Django
        </div>
        <div className="skill">
        ...
        <div className="skill">
          <i className="fas fa-server"></i> Nest.js
        </div>
        <div className="skill">
      ...
      <div className="field">
        ...
        <div className="skill">
          <i className="fas fa-table"></i> Excel
        </div>
        <div className="skill">
          <i className="fas fa-chart-bar"></i> Power BI
        </div>
        <div className="skill">
          <i className="fas fa-chart-pie"></i> Tableau
        </div>
      </div>
    </>
  );
